...
{
    /// <inheritdoc />
    public partial class AddUserBlogRelation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogPostUser", x => new { x.BlogPostsId, x.UsersUserId });
                    table.ForeignKey(
                        name: "FK_BlogPostUser_BlogPosts_BlogPostsId",
                        column: x => x.BlogPostsId,
                        principalTable: "BlogPosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BlogPostUser_Users_UsersUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentUser", x => new { x.CommentsId, x.UsersUserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogPostUser_UsersUserId",
                table: "BlogPostUser",
                column: "UsersUserId");
